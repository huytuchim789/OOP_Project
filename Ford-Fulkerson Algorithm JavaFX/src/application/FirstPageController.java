...
public class FirstPageController implements Initializable{
	...
	public void saveNodeInfos(ActionEvent event) {
		...
		System.out.println("Initial Node: "+startNd);
		System.out.println("End Node: "+finishNd);
...
//		Graph graph = generateNodes();
	...
	public void dynamicGraphMatrix ()
	{
		...
		System.out.println("The Graphic Matrix\n");
		 for(int i=0;i<n;i++){
			 for(int j=0;j<n;j++) {
...
//	 //   System.out.println("max fl :"+ff.getMaximumFlow());
	...
	public void initialize(URL url, ResourceBundle rb) {
		...
		TableColumn firstColumn=new TableColumn("First Node");
		TableColumn secondColumn=new TableColumn("Second Node");
		TableColumn thirdColumn=new TableColumn("Value");
